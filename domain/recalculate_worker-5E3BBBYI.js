...
(() => {
  ...
  // node_modules/ts-error-as-value/lib/utils.js
  var require_utils = __commonJS({
    "node_modules/ts-error-as-value/lib/utils.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.isPromise = void 0;
      var isPromise = (value) => value.then != null;
      exports.isPromise = isPromise;
    }
  });

  // node_modules/ts-error-as-value/lib/with-result.js
  var require_with_result = __commonJS({
    "node_modules/ts-error-as-value/lib/with-result.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.withResult = void 0;
      var index_1 = require_lib();
      var utils_1 = require_utils();
      var withResult2 = (fn, fnContext) => (...args) => {
        try {
          const data = fnContext ? fn.apply(fnContext, args) : fn(...args);
          if ((0, utils_1.isPromise)(data)) {
            return data.then((value) => (0, index_1.ok)(value)).catch((e) => (0, index_1.err)(e));
          }
      ...
      exports.withResult = withResult2;
    }
  });

  // node_modules/ts-error-as-value/lib/index.js
  var require_lib = __commonJS({
    "node_modules/ts-error-as-value/lib/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/ts-error-as-value/lib/partition-results.js
  var require_partition_results = __commonJS({
    "node_modules/ts-error-as-value/lib/partition-results.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.partitionResults = partitionResults;
      var utils_1 = require_utils();
      var isResultArray = (array) => array.every((item) => item && "data" in item && "error" in item);
      var isPromiseResultArray = (array) => array.every(utils_1.isPromise);
  ...
  // node_modules/ts-error-as-value/lib/globals.js
  var require_globals = __commonJS({
    "node_modules/ts-error-as-value/lib/globals.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var _1 = require_lib();
      var with_result_1 = require_with_result();
      var partition_results_1 = require_partition_results();
      var ResultIs = {
        success: (...args) => {
...
//# sourceMappingURL=recalculate_worker-5E3BBBYI.js.map
