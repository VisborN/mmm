...
(() => {
  // sw.ts
  var sw_default = null;
  var CACHE_NAME = `mmm-pwa-${"2026-09-10 09:03:08 +0300" ? "2026-09-10 09:03:08 +0300".replace(/\s+/g, "-") : "v1"}`;
  var PRECACHE_ASSETS = [
    "./",
    "./index.html",
    "./app.webmanifest",
  ...
  self.addEventListener("fetch", (event) => {
    ...
    if (url.hostname === "www.googleapis.com" || url.hostname === "accounts.google.com" || url.hostname.includes("tinkoff.ru") || url.hostname.includes("tbank.ru") || url.hostname.includes("sberbank.ru") || url.hostname.includes("yandexcloud.net") || url.pathname.startsWith("/proxy")) {
      return;
    }
